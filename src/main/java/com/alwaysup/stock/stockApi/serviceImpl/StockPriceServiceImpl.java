...
public class StockPriceServiceImpl implements StockService {
	...
	public Stock createStock(String symbol, String fullName, String exchange) throws IllegalArgumentException {
		...
		if (tempStock != null && tempStock.getSymbol().equalsIgnoreCase(symbol)) {
			return null;
		}
		...
		try {
			...
			if (symbol.equalsIgnoreCase(respSymbol)
					&& (exchange.equalsIgnoreCase(respExch) || exchange.equalsIgnoreCase(respExchange))) {
